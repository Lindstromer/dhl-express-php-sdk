...
use adiyya\DHLExpress\ExportLineItems;
use adiyya\DHLExpress\ExportLineItem;
use adiyya\DHLExpress\ExportDeclaration;

use adiyya\DHLExpress\OtherCharges;
use adiyya\DHLExpress\OtherCharge;
...
$exportLineItem
    ->setItemNumber(1)
    ->setQuantity(1)
    ->setQuantityUnitOfMeasurement('GM')
    ->setItemDescription('Test Product')
    ->setUnitPrice(23)
    ->setNetWeight(52)
    ->setGrossWeight(54)
    ->setManufacturingCountryCode('SA');
$exportLineItems->addexportLineItem($exportLineItem);

$otherCharges = new OtherCharges();
$otherCharges->setOtherCharge($otherCharge);

$exportDeclaration = new ExportDeclaration();
$exportDeclaration->setExportLineItems($exportLineItems)
    ->setInvoiceNumber(rand(100000, 999999))
